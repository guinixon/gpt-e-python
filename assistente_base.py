...
from openai.types.beta.assistant import Thread
...
class AssistenteBase():
    ...
    def criar_assistente(self, nome: str, instrucoes: str, modelo = "gptGPT-5 nano", file_id = ""):
    ...
    def criar_thread(self):
        return self.cliente.beta.threads.crate()
